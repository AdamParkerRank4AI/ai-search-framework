# compareSEO Instagram — Profile setup

Copy-paste ready. Open Instagram → Edit Profile → fill in each field below exactly as written.
...
| **Contact** | Business email only. No phone. |
...
## Profile highlights (set up on day 1, fill over time)
...
## Pinned posts (set after first week of posting)

Pin 3 posts to the top of the grid. These do 40% of the conversion work:

| Pin | What to pin | Why |
|-----|-------------|-----|
| 1 | Best-performing ranking reel or carousel (by saves) | Social proof — "this account makes things people save" |
| 2 | The methodology carousel (how we rank) | Trust — "this is real, not vibes" |
| 3 | The #1 spotlight reel or the voices list | Controversy / name recognition |
...
- [ ] Paste the bio text
- [ ] Set the link to `compareseo.co.uk`
- [ ] Switch to Professional Account → Business (not Creator)
- [ ] Create 9 blank highlight covers with correct names
- [ ] Follow every account in the `inspiration-swipe-file.md` anchor list
- [ ] Follow every account in the first ranking's `tag-list.md`
- [ ] Post the first ranking (post 1 of 2) from `output/`
- [ ] Pin it after 24 hours if it performs

---

## What NOT to do on day 1

- Don't add a Linktree. One direct link to compareseo.co.uk. Linktrees kill click-through.
- Don't use a personal photo as the profile pic. The brand IS the product — the logo builds recognition faster than a face on a media account.
- Don't put "DM for collabs" in the bio. That's for influencer accounts. compareSEO is a publisher.
- Don't add emojis to the bio. The dark, clean, text-first aesthetic starts in the bio.
- Don't set it as a Creator account. Business accounts get better analytics and the ability to schedule via third-party tools.
